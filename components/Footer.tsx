            ...
            <section className="SiteFooter__wrapper" id="footer">
                    ...
                    >
                        <ul>
                            <li>
                                <a
                                    target="_blank"
                                    href="https://www.tiktok.com/@dealgo8?_t=ZS-90K1ykUz9c2&_r=1"
                                    data-auto-id="true"
              ...
              C35.3,13.3,35.3,13.3,35.3,13.3z"
                            ...
                            <li>
                                <a
                                    target="_blank"
                                    href="https://www.facebook.com/share/173p5p5XDi/?mibextid=wwXIfr"
                                    data-auto-id="true"
                    ...
                    <div className="SiteFooter__footNote__inner">
                        ...
                        <div className="text">
                            ...
                            <div className="column">
                                <span className="copyright myfgray">
                                    All rights reserved © {(new Date().getFullYear())} DealGo
                                </span>
                            </div>
                        </div>
                    </div>
